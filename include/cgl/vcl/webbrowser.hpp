...
inline bool WebBrowser_IsReady(TWebBrowser* browser)
{
    /*
    return WebBrowser->ReadyState == Shdocvw::READYSTATE_COMPLETE;
    /*/
    return (browser->ReadyState != Shdocvw::READYSTATE_UNINITIALIZED) &&
        (browser->ReadyState != Shdocvw::READYSTATE_LOADING);
    //*/
}
