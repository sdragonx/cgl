...
using namespace cgl;
    ...
    #error ANDROID_API < 16
#endif

#define ANDROID_APP_LOG(...)   ((void)__android_log_print(ANDROID_LOG_INFO,  "android_app", __VA_ARGS__))
#define ANDROID_APP_WARN(...)  ((void)__android_log_print(ANDROID_LOG_WARN,  "android_app", __VA_ARGS__))
...
#define APP_LOG(...) ((void)__android_log_print(ANDROID_LOG_INFO, "app", __VA_ARGS__))
#define APP_WARN(...) ((void)__android_log_print(ANDROID_LOG_WARN, "app", __VA_ARGS__))
#define APP_ERROR(...) ((void)__android_log_print(ANDROID_LOG_ERROR, "app", __VA_ARGS__))
...
const char* input_motion_name(int action)
{
    ...
    case AMOTION_EVENT_ACTION_HOVER_MOVE:    //mouse move?
        return "AMOTION_EVENT_ACTION_HOVER_MOVE";
    case AMOTION_EVENT_ACTION_SCROLL:        //mouse wheel
        return "AMOTION_EVENT_ACTION_SCROLL";
    case AMOTION_EVENT_ACTION_HOVER_ENTER:    //mouse enter
        return "AMOTION_EVENT_ACTION_HOVER_ENTER";
    case AMOTION_EVENT_ACTION_HOVER_EXIT:    //mouse leave
...
const char* app_event_name(int id)
{
    switch (id)
    {
        ...
        case APP_LOW_MEMORY:        return "APP_LOW_MEMORY";
        ...
        case APP_WINDOW_RECT:        return "APP_WINDOW_RECT";
        case APP_WINDOW_PAINT:        return "APP_WINDOW_PAINT";
        case APP_INPUT:                return "APP_INPUT";
        case APP_TOUCH_DOWN:        return "APP_TOUCH_DOWN";
        case APP_TOUCH_UP:            return "APP_TOUCH_UP";
        case APP_TOUCH_MOVE:        return "APP_TOUCH_MOVE";
        case APP_KEY_UP:            return "APP_KEY_UP";
        case APP_KEY_DOWN:            return "APP_KEY_DOWN";
        case APP_KEY_PRESS:            return "APP_KEY_PRESS";
        default:
            break;
    }
    return "unknown APP event";
}
#endif
...
void android_app::process_begin(APP_EVENT& event)
{
    ...
    case APP_PAUSE:
        ...
        break;
    case APP_DESTROY:
        ANDROID_APP_LOGV("APP_DESTROY begin\n");
        break;
    case APP_SAVE:
    ...
    case APP_WINDOW_CLOSE:
        ANDROID_APP_LOGV("APP_WINDOW_CLOSE begin\n");
        break;
    case APP_INPUT:{
    ...
    default:
        ANDROID_APP_LOGV("APP_EVENT : %s = %d", app_event_name(event.id), event.id);
        break;
    }
}
...
void android_app::process_end(APP_EVENT& event)
{
    ...
    case APP_RESUME:
        ...
        break;
    case APP_DESTROY:
        ANDROID_APP_LOGV("APP_DESTROY end");
        this->running = false;
        break;
    case APP_SAVE:
        ...
        break;
    case APP_WINDOW_CLOSE:
        ANDROID_APP_LOGV("APP_WINDOW_CLOSE end\n");
        this->window = NULL;
        break;
    default:
        break;
...
{
    ANDROID_APP_WARN("android_app.dispose!");
    free_saved_state(this);
    //auto_lock lock(app->mutex);
    if(this->inputQueue){
        AInputQueue_detachLooper(this->inputQueue);
...
void android_app_post_event(android_app* app, const APP_EVENT& event)
{
    //ANDROID_APP_WARN("post_event : %s = %d", app_event_name(event.id), event.id);
...
void android_app_post_event(android_app* app, int id)
{
    APP_EVENT event = { ANDROID_APP_EVENT(id) };
...
void onDestroy(ANativeActivity* activity)
{
    ...
    while (!app->destroyed) {
        //ANDROID_APP_LOGV("wait app ...");
        auto_lock lock(app->mutex);
        app->cond_wait();
    }//
    //pthread_join(app->thread, 0);
    //ANDROID_APP_LOGV("app destroyed.");
...
{
    ANDROID_APP_LOGV("NativeActivity_onCreate: %p\n", activity);
